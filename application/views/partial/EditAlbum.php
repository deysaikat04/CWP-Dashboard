                                        ...
                                        <div class="panel-body">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Album Name</label><span
                                                            ...
                                                            <div class="col-lg-3 col-md-6">
                                                                <div class="thumbnail no-padding">
                                                                    <div class="thumb">
                                                                     ...
                                                                     <a href="<?php echo base_url(); ?>FormController/removeAlbumImage/<?php echo $img_row['album_id']; ?>/<?php echo $img_row['id']; ?>/<?php echo $img_row['file_name']; ?>"
                                                        ...
                                                        <div class="thumb">
                                                            ...
                                                            <div class="caption-overflow">
                                                                <span>
                                                                     ...
                                                                     <a href="<?php echo base_url(); ?>FormController/removeAlbumImage/<?php echo $img_row['album_id']; ?>/<?php echo $img_row['id']; ?>/<?php echo $img_row['file_name']; ?>" class="btn btn-flat border-white text-white btn-rounded btn-icon"><i class="icon-trash"></i></a>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
