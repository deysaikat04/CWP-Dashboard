        ...
        <div class="row">
                ...
                <div class="panel panel-body  bg-success-400 has-bg-image">
                    <div class="media no-margin">
                        <div class="media-body">
                            ...
                            <span class="text-uppercase text-size-mini">total albums</span>
                        </div>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="panel panel-body bg-orange-400 has-bg-image">
                    <div class="media no-margin">
                        <div class="media-body">
                            <h3 class="no-margin"><?php echo $countAll['allPort']; ?></h3>
                            <span class="text-uppercase text-size-mini">Portfolio images</span>
                        </div>
                ...
                <div class="panel panel-body bg-indigo-400 has-bg-image">
                    <div class="media no-margin">
                        ...
                        <div class="media-body text-right">
                            ...
                            <span class="text-uppercase text-size-mini">Videos</span>
                        </div>
                    </div>
                </div>
            </div>
