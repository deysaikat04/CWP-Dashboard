...
<head>
    ...
    <title>Candid Wedding Photography | Admin Dashboard</title>
...
<!--    <script type="text/javascript" src="--><?php //echo base_url()?><!--assets/js/plugins/tables/datatables/datatables.min.js"></script>-->
    ...
    <link href="<?php echo base_url()?>assets/css/gallery-grid.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url()?>assets/css/cwp.css" rel="stylesheet" type="text/css">
